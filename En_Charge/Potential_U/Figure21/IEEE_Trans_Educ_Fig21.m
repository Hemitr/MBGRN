...
for i=1:6*m0s
    ...
    Phip(i)=[Ups((p0+p1+20),i)-Ups((p0+p1+20+1),i)+2*FMMT(i)]*MP(nnum01,nnum02);
    Phim(i)=[Ups((p0+p1+20),i+6*m0s)-Ups((p0+p1+20+1),i+6*m0s)+2*FMMT(i+6*m0s)]*MP(nnum11,nnum12);
end
