...
% Terms coming from currents distribution in the slots
JA = -J*cos(pi*xd(u)/tp-2*pi/3);
JB = -J*cos(pi*xd(u)/tp+2*pi/3);
JC = -J*cos(pi*xd(u)/tp);
...
for i = 2:m
    nnum3  = (2*p0+1)*m+i;
    Bx1(i,u) = (C(nnum3-1)-C(nnum3-1-m))/h/la;
    Bx2(i,u) = (C(nnum3)-C(nnum3-m))/h/la;
    Bx(i,u)  = [Bx1(i,u)+Bx2(i,u)]/2;
end
nnum3  = (2*p0+1)*m+1;
Bx1(1,u) = (-C(nnum3-1+m)+C(nnum3-1))/h/la;
Bx2(1,u) = (C(nnum3)-C(nnum3-m))/h/la;
Bx(1,u)  = [Bx1(1,u)+Bx2(1,u)]/2;

% By component
for i = 2:m
    nnum3  = (2*p0+1)*m+i;
    By1(i,u) = (C(nnum3)-C(nnum3-1))/l/la;
    By2(i,u) = (C(nnum3-m)-C(nnum3-1-m))/l/la;
    By(i,u)  = -[By1(i,u)+By2(i,u)]/2;
end
nnum3  = (2*p0+1)*m+1;
By1(1,u) = (C(nnum3)+C(nnum3-1+m))/l/la;
By2(1,u) = (C(nnum3-m)+C(nnum3-1))/l/la;
By(1,u)  = -[By1(1,u)+By2(1,u)]/2;
